...
const Footer = () => {
  ...
  return (
    <footer className={`relative pt-10 sm:pt-24 pb-6 sm:pb-8 px-5 sm:px-6 overflow-hidden border-t ${isDark ? 'border-white/[0.04] bg-black' : 'border-black/[0.08] bg-neutral-100'}`}>
