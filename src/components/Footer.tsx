    ...
    <footer className={`relative pt-12 sm:pt-24 pb-6 sm:pb-8 px-4 sm:px-6 overflow-hidden border-t ${isDark ? 'border-white/[0.04] bg-black' : 'border-black/[0.08] bg-neutral-100'}`}>
      <div className="relative z-10 max-w-7xl lg:max-w-[90rem] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-10 sm:mb-16">
          ...
          <div>
            <p className={`text-sm font-semibold uppercase tracking-wider mb-4 ${isDark ? 'text-neutral-300' : 'text-neutral-700'}`}>Palvelut</p>
            <ul className={`space-y-3 text-sm ${isDark ? 'text-neutral-500' : 'text-neutral-500'}`}>
          ...
          <div>
            <p className={`text-sm font-semibold uppercase tracking-wider mb-4 ${isDark ? 'text-neutral-300' : 'text-neutral-700'}`}>Yritys</p>
            <ul className={`space-y-3 text-sm ${isDark ? 'text-neutral-500' : 'text-neutral-500'}`}>
