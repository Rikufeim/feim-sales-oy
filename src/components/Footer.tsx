...
const Footer = () => {
  ...
  return (
    <footer className={`relative -mt-px pt-10 sm:pt-24 pb-28 sm:pb-12 px-5 sm:px-6 overflow-hidden ${isDark ? 'bg-transparent' : 'border-t border-black/[0.08] bg-neutral-100'}`}>
