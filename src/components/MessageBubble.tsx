  ...
  return (
    <div className="fixed bottom-0 right-0 z-[100]">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-14 right-0 w-48 rounded-2xl border border-white/10 bg-black backdrop-blur-xl shadow-2xl overflow-hidden"
          >
            <div className="p-2 flex flex-col gap-1">
              <a
                ...
                className="flex items-center gap-2 p-2.5 rounded-xl hover:bg-white/5 transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 p-2.5 rounded-xl hover:bg-white/5 transition-colors"
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-blue-400 shrink-0">
      ...
      <button
        ...
        className="w-12 h-12 rounded-tl-2xl bg-black text-white flex items-center justify-center shadow-lg transition-transform duration-300 hover:scale-105"
