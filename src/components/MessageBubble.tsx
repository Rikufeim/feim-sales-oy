        ...
        {isOpen && (
          ...
          >
            <div className="p-5">
              ...
              <p className="text-neutral-400 text-xs mb-5">Vastaamme yleensä muutamassa tunnissa.</p>

              <a
                href="https://wa.me/358413282218?text=Hei!%20Olen%20kiinnostunut%20FEIM:n%20palveluista."
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 w-full p-3 rounded-xl bg-green-500/10 border border-green-500/20 hover:bg-green-500/20 transition-colors group mb-3"
              >
                <div className="w-9 h-9 rounded-full bg-green-500/20 flex items-center justify-center shrink-0">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4.5 h-4.5 text-green-400">
                ...
                <div>
                  <p className="text-green-400 text-sm font-medium group-hover:text-green-300 transition-colors">WhatsApp</p>
                  <p className="text-neutral-500 text-xs">Lähetä viesti suoraan</p>
                </div>
              </a>

              <a
                href="mailto:riku@feim.fi?subject=Yhteydenotto%20FEIM"
                className="flex items-center gap-3 w-full p-3 rounded-xl bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500/20 transition-colors group"
              >
                ...
                <div>
                  <p className="text-blue-400 text-sm font-medium group-hover:text-blue-300 transition-colors">Sähköposti</p>
                  <p className="text-neutral-500 text-xs">riku@feim.fi</p>
                </div>
              </a>
            </div>
          </motion.div>
