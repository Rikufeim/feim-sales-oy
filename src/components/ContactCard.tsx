...
const ContactCard = ({ className = "" }: { className?: string }) => (
  <div className={`inline-flex items-start gap-5 text-left bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 ${className}`}>
    <img src={rikuImg} alt="Riku Miettinen" className="w-24 h-24 rounded-2xl object-cover object-[center_15%] scale-150 grayscale hover:grayscale-0 transition-all duration-500" />
    <div>
