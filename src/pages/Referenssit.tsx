      ...
      <div className="max-w-7xl lg:max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
        <FadeIn>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link to="/yhteystiedot#vedos" className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-white hover:bg-neutral-200 text-black font-bold text-lg rounded-full transition-all duration-300 hover:scale-105 group">
