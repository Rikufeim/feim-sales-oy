      ...
      <section className="relative pb-32 overflow-hidden">
        <div className="max-w-7xl lg:max-w-[90rem] mx-auto px-6 lg:px-16 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <FadeIn delay={0.1}>
              <div className="lg:sticky lg:top-32 space-y-12">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <p className={`font-semibold text-xl ${contactName}`}>Riku Miettinen</p>
                    <p className={`text-sm mb-4 ${bodyText}`}>CEO, FEIM</p>
                ...
                {/* Company info */}
                <div className={`space-y-4 pt-8 border-t ${borderSub}`}>
            ...
            {/* Right: Form */}
            <FadeIn delay={0.2}>
              <div className={`border rounded-3xl p-8 md:p-10 backdrop-blur-sm ${formBg}`}>
                ...
                <form className="space-y-5" onSubmit={e => e.preventDefault()}>
                  ...
                  <button type="submit"
                    className="w-full font-bold text-base py-4 rounded-xl transition-all hover:scale-[1.01] active:scale-[0.99] mt-3 group flex items-center justify-center gap-2"
                    style={{ backgroundColor: isDark ? '#ffffff' : '#171717', color: isDark ? '#000000' : '#ffffff' }}>
                    Lähetä viesti
                    <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                  </button>
                  <p className={`text-xs text-center mt-2 ${isDark ? 'text-neutral-600' : 'text-neutral-400'}`}>
