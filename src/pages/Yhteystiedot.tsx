            ...
            <div className="inline-flex items-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                ...
                <div className="flex items-center gap-3">
                  <a href="mailto:riku@feim.fi" className={`text-sm transition-colors ${contactLink}`}>riku@feim.fi</a>
                  <span className={`w-1 h-1 rounded-full ${dotColor}`} />
                  <a href="tel:+358413282218" className={`text-sm transition-colors ${contactLink}`}>041 328 2218</a>
                  <span className={`w-1 h-1 rounded-full ${dotColor}`} />
                  <a href="https://wa.me/358413282218" target="_blank" rel="noopener noreferrer" className={`inline-flex items-center gap-1.5 text-sm transition-colors ${whatsappColor}`}>
