      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <FadeIn delay={0.1}>
            <div className="flex items-center gap-4 mb-10">
              <div className="w-14 h-14 rounded-xl overflow-hidden shrink-0">
                <img src={rikuImg} alt="Riku Miettinen" className="w-full h-full object-cover object-[center_20%] grayscale" />
              </div>
              <div>
        ...
        <FadeIn delay={0.1}>
          <div className="relative">
            <div className="rounded-3xl overflow-hidden aspect-[3/4] lg:aspect-[4/5]">
